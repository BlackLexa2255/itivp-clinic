...
request PUT "/api/appointments/$NEW_ID" '{"patientId":2,"doctorName":"Козлов Игорь Львович","specialty":"невролог","date":"2026-09-16","time":"13:30","status":"completed"}'
...
request POST "/api/patients" '{"fullName":"Новиков Денис Олегович","birthDate":"1995-07-19","phone":"+375291112233","medicalRecord":{"bloodType":"AB(IV) Rh+","allergies":[],"diagnoses":[]}}'
request POST "/api/patients" '{"phone":"+375291112233"}'
...
request PUT "/api/patients/$PATIENT_ID" '{"fullName":"Временный Пациент Изменённый","birthDate":"2000-01-01","phone":"+375290000000","medicalRecord":{"bloodType":"O(I) Rh+","allergies":["йод"],"diagnoses":[]}}'
